...
dantler_NA = dantler_NA[complete.cases(dantler_NA$AgeAccelResiduals), ]
...
reg_lm <- lm(AgeAccelResiduals ~ Cohort + Population + 
                  Weight + Antler_std+
...
reg_lm <- lm(AgeAccelResiduals ~ Weight_log + Antler_std_log + Cohort + Population + 
