...
dantler_NA = dantler_NA[complete.cases(dantler_NA$EpiSimpleDiffRap), ]
...
reg_lm <- lm(EpiSimpleDiffRap ~ Cohort + Population + 
                  Weight + Antler_std+
...
reg_lm <- lm(EpiSimpleDiffRap ~ Weight_log + Antler_std_log + Cohort + Population + 
