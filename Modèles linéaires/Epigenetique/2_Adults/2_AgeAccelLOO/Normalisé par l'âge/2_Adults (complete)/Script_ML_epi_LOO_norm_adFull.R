...
dantler_NA = dantler_NA[complete.cases(dantler_NA$AgeAccelLOORap), ]
...
reg_lm <- lm(AgeAccelLOORap ~ Cohort + Population + 
                  Weight + Antler_std+
...
reg_lm <- lm(AgeAccelLOORap ~ Weight_log + Antler_std_log + Cohort + Population + 
